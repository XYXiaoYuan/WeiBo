...
+ (NSArray *)defaultEmotions
{
    if (!_defaultEmotions) {
        ...
        _defaultEmotions = [YYEmotion objectArrayWithFile:plist];
...
+ (NSArray *)emojiEmotions
{
    if (!_emojiEmotions) {
        ...
        _emojiEmotions = [YYEmotion objectArrayWithFile:plist];
...
+ (NSArray *)lxhEmotions
{
    if (!_lxhEmotions) {
        ...
        _lxhEmotions = [YYEmotion objectArrayWithFile:plist];
